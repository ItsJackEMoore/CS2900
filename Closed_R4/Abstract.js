...
function finalize(){
    ...
    PS.audioPlay("start",{path: "Sounds/",loop:true,volume:0.80});
        ...
        case 1:
            ...
            switch(y){
                case 0:
                    ...
                    PS.audioPlay("spawn1",{path: "Sounds/",volume:0.50});
                    break;
                case 1:
                    PS.audioLoad("spawn2",{path: "Sounds/"});
                    PS.audioPlay("spawn2",{path: "Sounds/",volume:0.50});
                    break;
                case 2:
                    PS.audioLoad("spawn3",{path: "Sounds/"});
                    PS.audioPlay("spawn3",{path: "Sounds/",volume:0.50});
                    break;
                case 3:
                    PS.audioLoad("spawn4",{path: "Sounds/"});
                    PS.audioPlay("spawn4",{path: "Sounds/",volume:0.50});
                    break;
        ...
        case 2:
            ...
            switch(y){
                case 0:
                    ...
                    PS.audioPlay("beep1",{path: "Sounds/",volume: 0.05});
                    break;
                case 1:
                    PS.audioLoad("beep2",{path: "Sounds/"});
                    PS.audioPlay("beep2",{path: "Sounds/",volume: 0.05});
                    break;
                case 2:
                    PS.audioLoad("beep3",{path: "Sounds/"});
                    PS.audioPlay("beep3",{path: "Sounds/",volume: 0.05});
                    break;
                case 3:
                    PS.audioLoad("beep4",{path: "Sounds/"});
                    PS.audioPlay("beep4",{path: "Sounds/",volume: 0.05});
                    break;
